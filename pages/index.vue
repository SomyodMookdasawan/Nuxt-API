<template>
  <div>
    ...
    <v-card v-for="manga in results" :key="manga.mal_id" class="ma-2 " width="344px" height="230px" outlined>
    <v-list-item three-line>
      ...
      <img :src="manga.image_url" alt="" :style="{width: '80px',height:'150px' ,marginTop:'20px'}"/>
    </v-list-item>
